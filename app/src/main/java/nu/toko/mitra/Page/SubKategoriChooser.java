...
public class SubKategoriChooser extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        new ReqString(this, requestQueue).go(respon, SUBKATEGORI+getIntent().getStringExtra("id"));
    }

    void init(){
        ((TextView)findViewById(R.id.titel)).setText("Pilih Sub Kategori");
        ...
        adapter.setOnBuyClickListener(new ChooserAdapter.OnClickBuy() {
            ...
            public void onClick(ChooserModel productModel) {
                Intent i = new Intent();
                i.putExtra("subkategori", productModel.getPilihan());
        ...
        public void onResponse(String response) {
            try {
                ...
                for (int i = 0; i < array.length(); i++){
                    ...
                    chos.setId(object.getInt("id_sub_kategori"));
